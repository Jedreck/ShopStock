...
public class Storeyes extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s3 = intent.getStringExtra("price");
        s4 = intent.getStringExtra("stock");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button1) {
            Intent intent = new Intent(Storeyes.this, StoreMain.class);
        ...
        if (v.getId() == R.id.button2) {
            ...
            sendRequestWithOKHttp();
                Toast.makeText(Storeyes.this, "入库成功", Toast.LENGTH_SHORT).show();
        }
    }
